...
def menu(array:list):
    ...
    """
"Possible operations:"
1. Add a number (type 1 or add)
2. Insert a number (type 2 or insert)
3. Remove a number (type 3 or remove)
4. Remove a range of numbers (type 4 or remove range)
5. Replace a value or a range of values (type 5 or replace)
6. Print all the primes from a range (type 6 or primes)
7. Print all the odd numbers from a range (type 7 or odd)
8. Print the sum of numbers from a range (type 8 or sum)
9. Print the greatest common divisor of the numbers from a range (type 9 or greatest common divisor)
10. Print the maximum number from a range (type 10 or max)
11. Filter all the primes (type 11 or filter primes)
12. Filter all the negatives (type 12 or filter negatives)
13. Undo the last operation (type 13 or undo)
14. Print the array (type 14 or print)
15. Stop (type stop)
""")
    print()
    while True:
        ...
        if user_input == "stop":
            ...
            with open("Assignment_2_output.txt", "w") as g:
                g.write(str(array) + "\n")
            g.close()
            print("List was printed in Assignment_2_output.txt")
